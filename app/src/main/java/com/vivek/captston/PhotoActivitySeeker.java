...
public class PhotoActivitySeeker extends AppCompatActivity{


    Button chooseimgseeker,uploadimgseeker;
    ImageView uploadimgviewseeker;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       uploadimgseeker= (Button) findViewById(R.id.button_uploadimg_seeker);
        uploadimgviewseeker=(ImageView)findViewById(R.id.uploadimgviewseeker);
        ...
        rstorageReference=rstorage.getReference().child("Images").child("SeekerImages");
    }
        ...
        if(filepath!=null){
            ...
            ref.putFile(filepath).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    Picasso.get().load(urlToImage).transform(new CropCircleTransformation()).into(uploadimgviewseeker);
    ...
    public void onActivityResult(int requestcode,int resultcode,Intent data){
        if(resultcode==RESULT_OK){
            if(requestcode==SELECT_PICTURE){
                ...
                if(filepath!=null){
                    Picasso.get().load(filepath).transform(new CropCircleTransformation()).into(uploadimgviewseeker);
                }
            }
        }
    }
    ...
    public void chose_n_upload(View v) {
        int i=v.getId();
        switch(i){

            case R.id.button_chooseimg_seeker:
                Toast.makeText(getApplicationContext(),"Choose",Toast.LENGTH_SHORT).show();
                chooseImage();
                break;
            case R.id.button_uploadimg_seeker:
